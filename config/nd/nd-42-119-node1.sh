...
ND_SOURCE_DIR=/iso1/nd/beta/42.119
ND_IMAGE=nd-dk9.4.2.0.119d.qcow2
ND_DIR=nd42.119
ND_NAME=nd42.119d_n1
ND_INSTALL_DIR=/iso2/nd/$ND_DIR
ND_MGMT_NET=outside
ND_DATA_NET=BR_ND_DATA_12
ND_DISK1_IMAGE=nd-node1-disk1.qcow2
ND_DISK2_IMAGE=nd-node1-disk2.qcow2
